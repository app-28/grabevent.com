...
if($_SERVER["REQUEST_METHOD"] == "POST")
{
    ...
    $u_firstName = $_POST["inputFirstname"];
    $u_lastName = $_POST["inputLastname"];
    $u_username = $_POST["inputUsername"];
    $u_pwd = $_POST["inputPassword"];
    $u_email = $_POST["inputEmail"];
    $u_contact = $_POST["inputContact"];
    $u_city = $_POST["inputCity"];
    $u_state = $_POST["inputState"];

    $existsQuery = "SELECT * FROM `user-login` WHERE `email_address` = '$u_email' ";
    ...
    {
        $registerQuery = "INSERT INTO `user-login`(`u_firstName`, `u_lastName`, `u_username`, `u_pwd`, `email_address`, `contact_no`, `city`, `state`) VALUES ('$u_firstName','$u_lastName','$u_username','$u_pwd','$u_email','$u_contact','$u_city','$u_state') ";
...
<head>
    ...
    <title>Grab event - user register</title>
...
<body>
    <header>
        <nav class="navbar navbar-expand-lg fixed-top">
            <div class="container-fluid">
                ...
                <a class="nav-button nav-login-button" href="user-login.php">Log in</a>
                <a class="nav-button nav-signup-button" href="user-register.php">Sign up</a>
    ...
    <section class= "container">
        <div class="form-container">
            <form action= "user-register.php" method="POST" class= "row g-3">
                <h4 class="pt-4 pb-3">Registration [Attendee]</h4>
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    <label for="inputUsername" class="form-label ps-2">Username</label>
                    <div class="input-group has-validation">
                        <span class="input-group-text" id="inputGroupPrepend">@</span>
                        <input type="text" class="form-control" id="inputUsername" aria-describedby="inputGroupPrepend" name="inputUsername" required>
                    </div>
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    ...
                    <div class="input-group has-validation">
                        ...
                        <input type="text" pattern="[7-9]{1}[0-9]{9}" class="form-control" id="inputContact" aria-describedby="inputGroupPrepend" name="inputContact" required>
                    </div>
                </div>
                <div class="col-md-6">
