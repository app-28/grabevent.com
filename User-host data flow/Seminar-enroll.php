...
else
{
    ...
    $retrieveQuery = "SELECT `event_id`, `event_price` FROM `event` WHERE `event_name` = 'International Conference On Innovative Trend In Science, Engineering And Technology';";
...
<head>
    ...
    <link rel="stylesheet" href="../Stylesheets/all-event-styles/seminar.css">
</head>
<body>
<header> 
    ...
    <section class= "container">
        <div class="form-container">
            <form action= "Seminar-enroll.php" method="POST" class= "row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <select id="inputDate" class="form-select" name="inputDate" required>
                        <option selected>2025-04-10</option>   
                    </select>             
                </div>
                <div class="col-md-6">
                    ...
                    <select id="inputTime" class="form-select" name="inputTime" required>
                        <option selected>10:00am - 3:00pm</option>   
                    </select>                 
                </div>
                <div class="col-md-6">
