...
else
{
    ...
    $retrieveQuery = "SELECT `event_id`, `event_price` FROM `event` WHERE `event_name` = 'RAMBO CIRCUS';";
...
<head>
    ...
    <link rel="stylesheet" href="../Stylesheets/all-event-styles/rambo.css">
</head>
<body>
<header> 
    ...
    <section class= "container">
        <div class="form-container">
            <form action= "Rambo-enroll.php" method="POST" class= "row g-3">
                ...
                <div class="col-md-6">
                    <label for="inputVenue" class="form-label ps-2">Preferred Venue:</label>
                    <select id="inputVenue" class="form-select" name="inputVenue" required>
                        <option selected>B T Kawde Road</option>
                        <option>Mundhwa Road</option>
                    </select>             
                </div>
                <div class="col-md-6">
                    ...
                    <select id="inputDate" class="form-select" name="inputDate" required>
                        <option selected>2025-04-20</option>
                        <option>2025-04-21</option>
                        <option>2025-04-22</option>
                        <option>2025-04-23</option>
                        <option>2025-04-24</option>
                ...
                <div class="col-md-6">
                    ...
                    <select id="inputTime" class="form-select" name="inputTime" required>
                        <option selected>05:00pm - 08:00pm</option>   
                    </select>                 
                </div>
                <div class="col-md-6">
