...
if($_SERVER["REQUEST_METHOD"] == "POST")
{
    ...
    $u_loginParam = $_POST["inputUsername"];
    $u_pass = $_POST["inputPassword"];

    $loginQuery = "SELECT * FROM `user-login` WHERE `u_username` = '$u_loginParam' AND `u_pwd` = '$u_pass' ";
...
<head>
    ...
    <title>Grab event -  user login</title>
...
<body>
    ...
    <section class= "container">
        <div class="form-container">
            <form action= "user-login.php" method="POST" class= "row g-3">
                <h4 class="pt-4">Log in [Attendee]</h4>
                ...
                <div class="last-field col-md-12 pt-3 ps-5">
                    <a class="login-text ps-4" href="../User-host data flow/user-register.php">Don't have an account? Sign up</a>
                </div>
