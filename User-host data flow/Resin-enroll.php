...
else
{
    ...
    $retrieveQuery = "SELECT `event_id`, `event_price` FROM `event` WHERE `event_name` = 'Koi Pond Resin Art';";
...
<head>
    ...
    <link rel="stylesheet" href="../Stylesheets/all-event-styles/resin.css">
</head>
<body>
<header> 
    ...
    <section class= "container">
        <div class="form-container">
            <form action= "Resin-enroll.php" method="POST" class= "row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <select id="inputDate" class="form-select" name="inputDate" required>
                        <option selected>2025-04-15</option>   
                        <option>2025-04-16</option>
                        <option>2025-04-17</option>
                        <option>2025-04-18</option>
                        <option>2025-04-19</option>
                        <option>2025-04-20</option>
                    </select>             
                </div>
                <div class="col-md-6">
                    ...
                    <select id="inputTime" class="form-select" name="inputTime" required>
                        <option selected>11:00am - 12:30pm</option>
                        <option>12:30pm - 02:00pm</option>
                        <option>02:00pm - 03:30pm</option>
                        <option>03:30pm - 05:00pm</option>
                    </select>                 
                </div>
                <div class="col-md-6">
