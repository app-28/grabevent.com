...
else
{
    ...
    $retrieveQuery = "SELECT `event_id`, `event_price` FROM `event` WHERE `event_name` = 'World Jazz Festival - 5th Edition';";
...
<head>
    ...
    <link rel="stylesheet" href="../Stylesheets/all-event-styles/jazz.css">
</head>
<body>
<header> 
    ...
    <section class= "container">
        <div class="form-container">
            <form action= "Jazz-enroll.php" method="POST" class= "row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <select id="inputDate" class="form-select" name="inputDate" required>
                        <option selected>2025-05-05</option>   
                    </select>             
                </div>
                <div class="col-md-6">
                    ...
                    <select id="inputTime" class="form-select" name="inputTime" required>
                        <option selected>04:00pm - 9:00pm</option>   
                    </select>                 
                </div>
                <div class="col-md-6">
